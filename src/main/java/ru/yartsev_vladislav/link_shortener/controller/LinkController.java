...
@RestController
@Tag(name = "Links", description = "Операции для создания, получения, редактирования и удаления коротких ссылок")
public class LinkController {
    ...
    @Operation(
        ...
        description = "Создаёт новую короткую ссылку для переданного URL. "
    ...
    @ApiResponses({
        ...
        @ApiResponse(responseCode = "409", description = "Такая ссылка уже существует и ещё не истекла", content = @Content)
    })
    @PostMapping("/")
    public ResponseEntity<Object> createLink(
        @RequestBody CreateLinkOptions body,
        @Parameter(description = "Идентификатор пользователя", example = "f19b92f3-8a3e-4c63-9b77-1e9c50450fa1")
    ...
    @Operation(
        ...
        description = "Перенаправляет на оригинальный URL по короткому slug. "
    ...
    @ApiResponses({
        ...
        @ApiResponse(responseCode = "410", description = "Ссылка истекла или превышен лимит", content = @Content)
    })
    @GetMapping("/{slug}")
    ...
    @ApiResponses({
        ...
        @ApiResponse(responseCode = "403", description = "Недостаточно прав у пользователя", content = @Content),
        @ApiResponse(responseCode = "404", description = "Ссылка не найдена", content = @Content),
        @ApiResponse(responseCode = "401", description = "Пользователь не идентифицирован", content = @Content)
    })
    @DeleteMapping("/{slug}")
    ...
    @Operation(
        ...
        description = "Позволяет изменить лимит попыток для существующей ссылки, если она ещё не истекла."
    )
    @ApiResponses({
