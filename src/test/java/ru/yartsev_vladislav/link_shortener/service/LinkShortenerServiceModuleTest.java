...
public class LinkShortenerServiceModuleTest {
    ...
    void createLink_ShouldCreateAndReturnShortUrl() throws Exception {
        ...
        when(linkRepository.findByFullUrlAndOwnerIdAndCreatedAtGreaterThanEqual(anyString(), anyString(), any()))
    ...
    void createLink_ShouldThrowIfLinkExistsAndNotExpired() throws Exception {
        ...
        assertThrows(NotExpiredLinkAlreadyExistsException.class, () -> service.createLink(options, userId));
    }
    ...
    void ensureLinkWithOwner_ShouldThrowIfOwnerMismatch() {
        ...
        assertThrows(UserHasNotEnoughRightsException.class, () -> service.ensureLinkWithOwner("slug", "user2"));
    }
}
